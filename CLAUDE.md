...
- **Cursor-local banned-identity list (gitignored, not on GitHub):** `.cursor/private/banned-attribution-local.md` — generate with `bash scripts/cursor/install-user-git-environment.sh`; never copy tokens into tracked docs.
