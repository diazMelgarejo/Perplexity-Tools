# Perplexity-Tools v0.9.4.3

> **Top-level idempotent multi-agent orchestrator for Mac + Windows**
> Standardized first on `v0.9.0.0` — branch `v0.9.0.0` of [`diazMelgarejo/Perplexity-Tools`](https://github.com/diazMelgarejo/Perplexity-Tools); *`main` branch is now ahead at v0.9.4.3*
