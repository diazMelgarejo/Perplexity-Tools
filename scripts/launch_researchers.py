...
Environment:
    ...
    RESEARCHER_POLL_INTERVAL        seconds between rounds (default: 30); true/false enable flags
    RESEARCHER_CRASH_RECOVERY       crash-recovery wait seconds (default: 30); false disables
    RESEARCHER_INPUT_POLL_INTERVAL  portal user-input poll seconds (default: 5); true/false flags
